...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/OfficialCupCake",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#F11CB0", background: "#f8e6c5", backgroundDisabled: "#ef65a4", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#f8e6c5", primaryDark: "#F11CB0", tertiary: "#f8e6c5", text: "#ef65a4", textDisabled: "#696969", textSubtle: "#ef65a4", borderColor: "#FF0000", card: "#ffffff", gradients: {
